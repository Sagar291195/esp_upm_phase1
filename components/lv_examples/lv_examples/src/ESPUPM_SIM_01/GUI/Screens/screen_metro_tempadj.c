...
void callMetroTempAdjust(void)
{
    ...
    lv_obj_align(_mtaPointValLbl, _mtaMetroHeadingCont, LV_ALIGN_OUT_BOTTOM_MID, 0, 10);
    ...
    lv_obj_set_style_local_scale_border_width(_mtaValidBtn, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, 0);
    lv_obj_set_style_local_bg_color(_mtaValidBtn, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_MAKE(0x5D,0xAF,0x48));
    ...
    lv_style_set_text_color(&_mtaValidBtnLblStyle, LV_LABEL_PART_MAIN, LV_COLOR_WHITE);
    lv_obj_add_style(_mtaValidBtnLbl, LV_LABEL_PART_MAIN, &_mtaValidBtnLblStyle);
