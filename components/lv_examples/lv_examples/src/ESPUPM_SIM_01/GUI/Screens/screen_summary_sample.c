...
/**
 * @brief sample data to be get from the database
 *
 */
static uint32_t uSampleNumber = 0;
/**
 * @brief sequnce data to be get from the database
 *
 */
static uint8_t uSequnceNumber = 0;

/**
 * @brief data variable to store the data from the database
 *
 */
...
void sssSummarySampleScreen(void)
{
        ...
        /**
         * @brief checking if sequnece run sucessfully and set the ok or cross sign accordingly
         *
         */
